...
@dataclass
class TeslaCarDocsPreAP(CarDocs):
  package: str = "All"
  car_parts: CarParts = field(default_factory=CarParts.common([CarHarness.tesla_a]))
...
@dataclass
class TeslaPreAPPlatformConfig(PlatformConfig):
  dbc_dict: DbcDict = field(default_factory=lambda: {Bus.party: 'tesla_can_pre1916', Bus.chassis: 'tesla_can_pre1916', Bus.radar: 'tesla_radar'})
